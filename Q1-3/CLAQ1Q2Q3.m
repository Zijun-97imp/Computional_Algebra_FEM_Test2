...
fprintf(' \nQ2d. Storage using in the initial matlab language loop: %.0fbites.', memoi);
...
fprintf(' \nQ2d. Storage using in the initial matlab language loop: %fs.', TimeStoppingi);
fprintf(' \nQ2d. Storage using in different function: RQI and HHD: %fs;QRITER: %fs;SSI and RITZ: %fs.', TimeStopping1 , TimeStopping2 , TimeStopping3);
